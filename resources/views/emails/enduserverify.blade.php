    ...
    <body>
        <div class="content-wrap" style="display: block;Margin:0 auto;margin:0 auto;background-color: #323232;width:600px;">
            <div class="content" style="padding: 10px; background-color: #ffffff;text-align: center;font-size: 18px;color: #323232;padding: 20px 30px;">
                ...
                <a href="{{URL::to('http://localhost:8000/userconfirmed')}}/{{$data->token}}" style="background-color: #66cc9a;border:3px solid #63c694;display: inline-block;padding: 10px 40px;box-shadow: 1px 3px 5px #63c694;text-decoration: none;cursor: pointer;color: white;margin: 30px auto;Margin:30px auto;">VERIFY</a>
            </div>
